...
* dislike-color: Green, Orange, White

Then a shopper can be imported with the following preferences: `color:Green,Orange;Black;styles:Vintage;dislike-color:Green`. And shopper preferred product categories will be:
